...
vault-encrypt:
	ansible-vault encrypt ansible/group_vars/$(group)/vault.yml  --vault-password-file playground/vault-password.txt

vault-edit:
	ansible-vault edit ansible/group_vars/$(group)/vault.yml --vault-password-file playground/vault-password.txt

vault-view:
	ansible-vault view ansible/group_vars/$(group)/vault.yml --vault-password-file playground/vault-password.txt
...
release:
	ansible-playbook -i ansible/inventory.ini --vault-password-file playground/vault-password.txt --ssh-extra-args "-F ssh_config" ansible/release.yml
